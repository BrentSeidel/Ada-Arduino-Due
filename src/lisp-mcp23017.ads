package lisp.mcp23017 is
   ...
   --      unsigned integer
   --
--   function mcp23017_dir(s : BBS.lisp.cons_index) return BBS.lisp.element_type;
   ...
   --      unsigned integer
   --
--   function mcp23017_pullup(s : BBS.lisp.cons_index) return BBS.lisp.element_type;
   ...
   --      unsigned integer
   --
--   function mcp23017_polarity(s : BBS.lisp.cons_index) return BBS.lisp.element_type;
   ...
   --
--   function mcp23017_data(s : BBS.lisp.cons_index) return BBS.lisp.element_type;
   ...
   --
--   function mcp23017_read(s : BBS.lisp.cons_index) return BBS.lisp.element_type;
